        ...
        <div className="sell-container" ref={sellContainerRef}>
                ...
                <div className="nft-collection-section">
                    ...
                    {loadingUserNFTs ? (
                        ...
                        <div className="nft-collection-grid">
                            {userNFTs.map((nft, index) => (
                                <div 
                                    ...
                                    title="Click to select this NFT for listing"
                                >
                        ...
                        <div className="collection-empty">
                            ...
                            <p>You can still create listings by manually entering the contract address and token ID below.</p>
                            <button 
                                type="button" 
                                className="secondary-button"
                                onClick={loadUserNFTs}
            ...
            {!wallet && (
                <div className="wallet-connect-prompt">
                    ...
                    <p>Connect your wallet to view your NFT collection and create listings.</p>
